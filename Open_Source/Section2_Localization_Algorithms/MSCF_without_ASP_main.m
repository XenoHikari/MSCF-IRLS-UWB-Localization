...
%   including multi-subset consistency fusion
%
...
Anchor_class{1,1} = [1,4,6,7,9,10,11];  %good
Anchor_class{1,2} = [1,4,5,8,9,10,12];  %good
Anchor_class{1,3} = [2,3,5,8,9,10,12];  %good
Anchor_class{1,4} = [2,3,6,7,9,10,12];  %good
Anchor_class{1,5} = [1,2,7,8,9,11,12];  %good
